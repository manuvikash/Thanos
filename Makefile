...
package-lambdas:
	...
	@echo "Packaging config_handler..."
	@mkdir -p dist/config_handler_build
	@cp -r lambdas/common dist/config_handler_build/
	...
	@cp -r lambdas/common dist/groups_handler_build/
