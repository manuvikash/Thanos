...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-[#0C1A1A] flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-6 md:px-12 lg:px-24 pb-24">
          <div className="max-w-4xl mx-auto w-full text-center space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <Link 
                to={ROUTES.REGISTER}
                className="group relative overflow-hidden bg-[#102020]/50 border border-neutral-800 hover:border-cyan-500/50 rounded-xl p-8 transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(6,182,212,0.3)] text-left"
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <h2 className="text-2xl font-bold text-neutral-100 font-mono-custom">
                    Onboard Resources
                  </h2>
              ...
              <Link 
                ...
                className="group relative overflow-hidden bg-[#102020]/50 border border-neutral-800 hover:border-teal-500/50 rounded-xl p-8 transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(20,184,166,0.3)] text-left"
              >
        ...
        <footer className="border-t border-neutral-800 bg-[#0C1A1A] py-8 px-6">
